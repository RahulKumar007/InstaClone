...
# Initaialising globally but will probably use imgur
cloudinary.config(
  cloud_name = "dit-university",
...
# Upvote controller (A lot similar to like)
...
def logout_view(request):
    ...
    if user:
        ...
        # Flushing the session from the dB. No session no user :)
...
# Sending a ton of mails for every little thing to the bored user
...
# An attempt for url querying
# IMPORTANT
# To get posts of particular user use following syntax in pageindex
# http://localhost:8000/q?uid=user_id
